  ...
  return (
    <div className="py-24 px-4 bg-[#0b0b0b]">
      <div className="container mx-auto max-w-4xl">
        <h1 className="text-5xl font-black text-white mb-10 tracking-tight">Who I Am.</h1>
        ...
        <div className="prose prose-invert prose-lg text-zinc-400 space-y-8 max-w-none font-medium">
          ...
          <div className="bg-zinc-900 p-10 rounded-3xl border border-zinc-800 my-16 shadow-2xl">
            <h3 className="text-2xl font-bold text-white mb-8 tracking-tight">What I Promise You:</h3>
            <ul className="space-y-6">
              <li className="flex gap-4">
                <span className="bg-blue-600/10 text-blue-500 p-2 rounded-lg flex-shrink-0">
                   <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={3} d="M13 10V3L4 14h7v7l9-11h-7z" /></svg>
                </span>
                <span><strong className="text-white">Fast Delivery:</strong> Most websites are ready within 3 to 7 days.</span>
              </li>
              <li className="flex gap-4">
                <span className="bg-blue-600/10 text-blue-500 p-2 rounded-lg flex-shrink-0">
                ...
                <span><strong className="text-white">Local Synergy:</strong> Being in Delhi means I can discuss your vision easily. I am not an agency; I am local and always available.</span>
              </li>
              <li className="flex gap-4">
                <span className="bg-blue-600/10 text-blue-500 p-2 rounded-lg flex-shrink-0">
                   <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={3} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" /></svg>
                </span>
                <span><strong className="text-white">Zero Tension:</strong> You don't need to know anything technical. Just share your business details — I handle everything else.</span>
              </li>
            </ul>
          </div>
          ...
          <div className="pt-16 border-t border-zinc-900">
            <h3 className="text-3xl font-bold text-white mb-6 tracking-tight">Let's Talk About Your Website.</h3>
            <p className="mb-10 text-zinc-400">WhatsApp me or call directly — I'll reply within a few hours.</p>
